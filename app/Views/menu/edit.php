...
<h1> <i class="bx bx-dish bx-md"></i> Modifica Menu</h1>
    ...
    <div class="row g-3">
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="text" name="menu_name" class="form-control form-control-lg" id="menu_name" aria-describedby="defaultFormControlHelp" value="<?= $menu['menu_name'] ?>" required/>
                <div id="defaultFormControlHelp" class="form-text">Inserisci un nome descrittivo per il tuo menù</div>
            </div>

            <div class="mb-3">
                <label for="description" class="form-label">Descrizione:</label>
                <input type="text" name="description" class="form-control form-control-lg" id="description" aria-describedby="defaultFormControlHelp" value="<?= $menu['description'] ?>" required/>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="number" name="price_per_person" class="form-control form-control-lg" id="price_per_person" aria-describedby="defaultFormControlHelp" value="<?= $menu['price_per_person'] ?>" required/>
        ...
        <?php if (!empty($menu_items)) :?>
            ...
            <?php foreach ($menu_items as $menu_item) : ?>
                ...
                <label class="checkbox switch switch-primary">
                    ...
                    <input type="checkbox" class="switch-input" name="menu_items[]" value="<?= $menu_item['item_id'] ?>" <?= $checked ?>>
