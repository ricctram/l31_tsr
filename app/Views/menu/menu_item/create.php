...
<h1> <i class="bx bx-bowl-hot bx-md"></i> Crea nuovo piatto</h1>
    ...
    <div class="col-md-6">
        <div class="mb-3">
            <label for="item_name" class="form-label">Nome piatto:</label>
                <input type="text" name="item_name" class="form-control form-control-lg" id="item_name" aria-describedby="defaultFormControlHelp" required/>
            <div id="defaultFormControlHelp" class="form-text">Inserisci un nome descrittivo per il tuo piatto</div>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                ...
                <input type="number" name="price" class="form-control form-control-lg" id="price" aria-describedby="defaultFormControlHelp" required/>
